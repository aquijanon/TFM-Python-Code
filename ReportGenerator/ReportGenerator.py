...
#Regla para saber las coordenadas

def drawMyRuler(pdf):
    pdf.drawString(100,1410, 'x100')
    pdf.drawString(200,1410, 'x200')
    pdf.drawString(300,1410, 'x300')
    pdf.drawString(400,1410, 'x400')
    pdf.drawString(500,1410, 'x500')
    pdf.drawString(600,1410, 'x600')
    pdf.drawString(700,1410, 'x700')
    pdf.drawString(800,1410, 'x800')
    pdf.drawString(900,1410, 'x900')
    pdf.drawString(1000,1410, 'x1000')
    ...
    pdf.drawString(10,1000, 'y1000')
    pdf.drawString(10,1100, 'y1100')
    pdf.drawString(10,1200, 'y1200')
    pdf.drawString(10,1300, 'y1300')
    pdf.drawString(10,1400, 'y1400')
    pdf.drawString(10,1500, 'y1500')
    pdf.drawString(10,1600, 'y1600')
    pdf.drawString(10,1700, 'y1700')    
...
#pdf.setPageSize((374, 510.5))

#Llamada a la funcion que crea un mapa de coordenadas en el linzo a forma de regla para saber las posiciones
#drawMyRuler(pdf)

#Para saber las fuentes disponible que tiene la libreria
